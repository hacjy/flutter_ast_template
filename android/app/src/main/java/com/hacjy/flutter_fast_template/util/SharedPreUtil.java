...
public class SharedPreUtil {
    ...
    public static Object jsonToClass(Context context, String fileName, String nodeName, Type type) {
        String json = SharepreferenceUtil.getSharePreString(context, fileName, nodeName, "");
    ...
    public static void saveClass(Context context, String nodeName, Object object) {
        try {
            put(context, nodeName, JsonUtil.objectToString(object));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
